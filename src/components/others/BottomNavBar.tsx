...
function BottomNavBar() {
  return (
    <div className="w-full lg:w-[1000px] xl:w-[1200px] border-t border-t-[#8a8f98]/20 flex justify-center items-start">
      <div className="w-full lg:w-[1000px] xl:w-[1200px] lg:h-[359px] mt-[56px] px-[24px] lg:pl-[32px] lg:pr-0 flex flex-col lg:flex-row justify-start items-start">
        {/*Logo and social tags*/}
        <div className="w-full lg:w-[188px] xl:w-[220px] lg:h-[293px] flex flex-row lg:flex-col justify-between items-start">
        ...
        <div className="mt-[40px] lg:mt-0 lg:ml-[60px] xl:ml-[197px] flex flex-col lg:flex-row justify-start items-start">
          <div className="flex justify-start items-start">
            <div className="w-[180px] lg:h-[293px] flex flex-col justify-start items-start">
              <h3 style={bottomNavHeaderStyle}>Product</h3>
              <p style={bottomNavBodyStyle}>Features</p>
              <p style={bottomNavBodyStyle}>Integrations</p>
              <p style={bottomNavBodyStyle}>Pricing</p>
              <p style={bottomNavBodyStyle}>Changelog</p>
              <p style={bottomNavBodyStyle}>Docs</p>
              <p style={bottomNavBodyStyle}>Linear Method</p>
              <p style={bottomNavBodyLastStyle}>Download</p>
            </div>
            <div className="lg:w-[180px] lg:h-[293px] flex flex-col justify-start items-start ml-[30px] lg:ml-0">
              <h3 style={bottomNavHeaderStyle}>Company</h3>
              <p style={bottomNavBodyStyle}>About us</p>
              <p style={bottomNavBodyStyle}>Blog</p>
              <p style={bottomNavBodyStyle}>Careers</p>
              <p style={bottomNavBodyStyle}>Customers</p>
              <p style={bottomNavBodyLastStyle}>Brand</p>
            </div>
          </div>

          <div className="flex justify-start items-start mt-[30px] lg:mt-0">
            <div className="w-[180px] lg:h-[293px] flex flex-col justify-start items-start">
              <h3 style={bottomNavHeaderStyle}>Resources</h3>
              <p style={bottomNavBodyStyle}>Community</p>
              <p style={bottomNavBodyStyle}>Contact</p>
              <p style={bottomNavBodyStyle}>DPA</p>
              <p style={bottomNavBodyStyle}>Terms of service</p>
              <p style={bottomNavBodyLastStyle}>Report a vulnerability</p>
            </div>
            <div className="lg:w-[180px] lg:h-[293px] flex flex-col justify-start items-start ml-[40px] lg:ml-0">
              <h3 style={bottomNavHeaderStyle}>Developers</h3>
              <p style={bottomNavBodyStyle}>API</p>
              <p style={bottomNavBodyStyle}>Status</p>
              <p style={bottomNavBodyStyle}>GitHub</p>
              <p style={bottomNavBodyLastStyle}>Magic</p>
            </div>
          </div>
        </div>
      </div>
